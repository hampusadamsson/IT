(*
Training test cases for PKD assignment 2 (Quadtrees), VT 13
Developed by Karl S.B. (karl.sundequist@it.uu.se)
Last updated 2013-01-23 by Lars-Henrik Eriksson

To run these training cases:
   1) launch PolyML shell [poly]
   2) load hand-in [use "<handin_filename>.sml"]
   3) load training set [use "assignment2-training.sml"]
*)
...
local
    (* createQtree e rs
       ...
       POST: A quadtree with the specified extent containing all rectangles.
    *)
    ...
    fun trainingCase 0 =
      ...
      | trainingCase 4 =
        let (* Test each quadrant respecively *)
