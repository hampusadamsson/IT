(* PROGRAMKONSTRUKTION OCH DATASTRUKTURER
   ASSIGNMENT 2
   Författare: Philip Åkerfeldt & Gabriel Jonsson
   Datum: 1 Februari 2013
   Inlämning: 1
*)

(* REPRESENTATION CONVENTION: Rect(Left,Top,Right,Bottom)
Datatypen representeras av fyra stycken heltalsvärden som är koordinaterför rektangelns sidor. Rektangeln har Left som x-koordinat för vänstra sidan, Top som y-koordinat för den övre sidan, Right som x-koordinat för högra sidan och Bottom som y-koordinat för den undre sidan.  
...
bottomRight är ett subträd till det icke-tomma quadträdet och representerar kvaranten längst ner till höger.
   REPRESENTATION INVARIANT: alla rektanglar är korrekta.
*)
...
*)       	 
(* VARIANT: Depth q *)
(* TIME COMPLEXITY: Worst Case: Theta(n), n= djupet på quadträdet q *) 
...
*)         
(* VARIANT: Lenght l *)
(* TIME COMPLEXITY: Worst Case: Theta(n), n= listans längd*)
