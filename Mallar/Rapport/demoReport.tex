...
AD2 course.  The \LaTeX\ source code of this document exemplifies
almost everything you need to know about \LaTeX\ in order to typeset a
professional-looking assignment report (for the AD2 course).  Use it
as a starting point for imitation and delete everything irrelevant.
...
course(s) you take and when writing your BSc, MSc, or PhD thesis.
...
already in the hand, from right to left, as illustrated in
Figure~\ref{fig:isort}.  At all times, the cards held in the left hand
...
\lstinputlisting[firstline=9,lastline=26,float=t,label=pgm:isort,caption={Python
  ...
  CLRS3~\cite{CLRS}. \handpoint~Compare for instance
